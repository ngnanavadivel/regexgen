...
public class RegexGenerator {
   ...
   private static final List<String> REGEX_RESERVED_CHARS = Arrays.asList(new String[] { ".", "+", "*", "(", ")", "?",
         "{", "}", "\\", "-", "^", "$" });
   /*
    * Flags to mark whether the current and last character parsed are a Digit | Alphabet | Whitespace | Special
    * character
    */
   ...
   /*
    * Returns the Regular Expression for the current character based on whether it's a Digit or Alphabet or Whitespace
    * or Neither of them
    */
